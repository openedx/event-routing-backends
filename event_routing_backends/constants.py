"""
Constants used by event_routing_backends
"""
...
class ProjectType():
    ...
    that are available in the edx-platform. event_routing_backends app use these values to
...
class SettingsType():
    ...
    that are available for extension in the edx-platform. event_routing_backends use these
